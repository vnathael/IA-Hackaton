window.onload = () => {
    ...
    let infoTexts = [
      ...
      "Causes : Les déchets plastiques descendent jusqu'aux grandes profondeurs.",
      "Causes : Le plastique est transporté par les courants jusque dans les abysses.",
      "Causes : Les microplastiques polluent les zones profondes où vivent ces poissons.",
      "Causes : Les déchets des activités humaines atteignent toutes les couches de l’océan.",
      "Causes : L’absence de traitement des déchets favorise leur accumulation en mer.",
      "Effet : Les poissons-lanternes ingèrent des microplastiques toxiques.",
      "Effet : Leur lumière naturelle peut être perturbée par la pollution plastique.",
      "Effet : La pollution affaiblit le système immunitaire des poissons.",
      "Effet : Le plastique détruit leur habitat dans les abysses.",
      "Effet : Les poissons-lanternes deviennent plus vulnérables aux prédateurs.",
  ];
...
function handleKeyUp(e) {
    ...
    function drawUI() {
      ctx.fillStyle = 'white';
      ctx.font = '18px Arial';
      ctx.fillText(`Poissons tués: ${killedTurtles}`, canvas.width - 180, 20);
    }
