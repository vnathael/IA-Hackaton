window.onload = () => {
    ...
    let infoTexts = [
      ...
      "Causes : Les sacs plastiques flottent en mer, attirant les calmars par erreur.",
      "Causes : Les filets de pêche abandonnés piègent les calmars en profondeur.",
      "Causes : Des tonnes de déchets plastiques finissent chaque jour dans l’océan.",
      "Causes : Le plastique met plus de 400 ans à se décomposer dans l’eau salée.",
      "Causes : Le rejet des plastiques par les navires pollue les zones de chasse des calmars.",
      "Effet : Les calmars confondent le plastique avec des proies et s’étouffent.",
      "Effet : Le plastique bloque les mouvements des calmars, les rendant vulnérables.",
      "Effet : Les calmars absorbent des microplastiques en filtrant l’eau.",
      "Effet : La pollution perturbe les migrations naturelles des calmars.",
      "Effet : Le plastique détruit les zones de reproduction des calmars en mer.",
  ];
...
function handleKeyUp(e) {
    ...
    function drawUI() {
      ctx.fillStyle = 'white';
      ctx.font = '18px Arial';
      ctx.fillText(`Calmars tués: ${killedTurtles}`, canvas.width - 180, 20);
    }
